...
function setup() {   
    ...
    //create sliders
    // textSize(15);
    textSize(0.02*windowY);
    noStroke();
    rSlider = createSlider(0, 255, 255);
    rSlider.position(border_right+0.02*windowX, 20);
    gSlider = createSlider(0, 255, 150);
    gSlider.position(border_right+0.02*windowX, 50);
    bSlider = createSlider(0, 255, 125);
    bSlider.position(border_right+0.02*windowX, 80);
}
